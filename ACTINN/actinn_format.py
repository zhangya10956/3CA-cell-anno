...
def get_parser(parser=None):
    ...
    parser.add_argument("-i", "--input", type=str, help="Path to the input file or the 10X directory.", default='D:/PyCharm Community Edition 2021.2.3/dataset/DBSY/NeuCA-R/1-68K_PBMC/0719-HVG2000-noscale/CSV-1013/1014-testadata10lei-T.csv')
    parser.add_argument("-o", "--output", type=str, help="Prefix of the output file.", default='D:/PyCharm Community Edition 2021.2.3/dataset/DBSY/NeuCA-R/1-68K_PBMC/0719-HVG2000-noscale/CSV-1013/1014-testadata10lei-T.h5')
    parser.add_argument("-f", "--format", type=str, help="Format of the input file (10X_V2, 10X_V3, txt, csv).", default='csv')
    return parser
